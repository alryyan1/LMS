...
function TeethModel({ actviePatient, user, setActiveDoctorVisit, settings }:TeethModelProbs) {
  const [show, setShow] = useState(false);
  const [activeTooth, setActiveTooth] = useState(null);

  const toothes = actviePatient.requested_tooth_services.map((ts)=>ts.tooth_id)
