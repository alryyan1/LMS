...
import { formatNumber, sendNotifications } from "../constants";
import dayjs from "dayjs";
import { AdapterDayjs } from "@mui/x-date-pickers/AdapterDayjs";

function PettyCashPermissionForm({setAllPermissions}) {
  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      formData.append("date", selectedDate.format("YYYY-MM-DD")); // تنسيق التاريخ
      ...
      console.log(response.data,'dddddddddddddddddddddddddddddddddddddddddddddd'); // Log the response data
      sendNotifications(
        response.data.data.id,
        "اذن صرف جديد",
        `${response.data.data.description} \n  المبلغ  ${formatNumber(response.data.data.amount)}   `
      );
        setAllPermissions((prev) => [ response.data.data,...prev]);
