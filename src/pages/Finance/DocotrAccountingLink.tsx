...
function DoctorFinanceLink() {
  ...
  return (
    <>
                ...
                <TableBody>
                  {doctors.map((doctor) => (
                    <TableRow key={doctor.id}>
                      ...
                      <TableCell>
                        <Autocomplete
                          value={doctor.cash_account}
                          onChange={(e, newVal) => {
                           axiosClient.patch(`doctors/${doctor.id}`,{
                          ...
                          options={accounts}
                          renderInput={(params) => (
                            <TextField {...params} label="حساب النقدي" />
                          )}
                        />
                      </TableCell>
                      <TableCell>
                        <Autocomplete
                        value={doctor.insu_account}
                          onChange={(e, newVal) => {
                            axiosClient.patch(`doctors/${doctor.id}`,{
                                colName:'finanace_account_id_insurance',
                                val:newVal.id
                               })
                          }}
                          getOptionKey={(op) => op.id}
      ...
      {selectedDoctor && (
        <EmptyDialog show={openCosts} setShow={setOpenCosts}>
...
export default DoctorFinanceLink;
