...
function SearchDialogLab({setPatients, lab = false, user, update, isReception, hideForm,setActiveShift,openedDoctors ,activeShift}:SearchDialogLabProbs) {
  const {
    foundedPatients,
    setDialog,
    doctors,
...
export default SearchDialogLab;
