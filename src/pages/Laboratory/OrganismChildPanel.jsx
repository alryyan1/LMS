...
function OrganismChildPanel(props) {
    const { children, value, index,organism,setShift, ...other } = props;
        ...
        {value === index && (
          <Box  className='group' sx={{ p: 3 }}>
            <Button onClick={()=>{
                ...
                if (result) {
                    axiosClient.delete(`deleteOrganism/${organism.id}`).then(({data})=>{
                        setShift((prev)=>{
                ...
                <TableBody>
                    <TableRow>
                        ...
                        onChange={(e)=>{
                            ...
                            axiosClient.patch(`editOrganism/${organism.id}`,{val:e.target.value,colName:'organism'}).then(({data})=>{
                                console.log(data)
                            })
                    ...
                    <TableRow>
                        ...
                        onChange={(e)=>{
                            ...
                            axiosClient.patch(`editOrganism/${organism.id}`,{val:e.target.value,colName:'sensitive'}).then(({data})=>{
                                console.log(data)
                            })
                    ...
                    <TableRow>
                        ...
                        onChange={(e)=>{
                            ...
                            axiosClient.patch(`editOrganism/${organism.id}`,{val:e.target.value,colName:'resistant'}).then(({data})=>{
                                console.log(data)
                            })
