...
function PatientForm({  hideForm,setUpdate }) {
  ...
  const sumbitHandler = async (formData) => {
    ...
    axiosClient.post(`patients/add`, {...formData,doctor_id:formData.doctor.id}).then((data) => {
 ...
 >
            ...
            <TextField error={errors?.age_year } {...register("age_year",{required:{value:true,message:"يجب ادخال العمر بالسنه"}})} label="السنه" variant="standard" />
            </Item>
            <Item>
            <TextField
              {...register("age_month")}
            ...
            <TextField {...register("age_day")} label="اليوم" variant="standard" />
            </Item>
            ...
            render={({ field }) => (
              <Autocomplete
                ...
                renderInput={(params) => {
                  ...
                  return <TextField error={errors?.doctor} {...params} label="الطبيب" />;
                }}
              ></Autocomplete>
            )}
          />
