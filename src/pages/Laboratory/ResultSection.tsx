    ...
    <>
      ...
      {selectedReslult && (
        <EmptyDialog show={show} setShow={setShow}>
          <Stack gap={2} direction={"row"}>
            {selectedDevice && (
              <DeviceChildNormalRange
                setDeviceNormalRange={setDeviceNormalRange}
                deviceNormalRange={deviceNormalRange}
      ...
      <EmptyDialog show={showComment} setShow={setShowComment}>
        <CodeEditor
          ...
          options={complains}
          init={
            patient.patient.labrequests.find((t) => selectedTest.id == t.id)
              .comment ?? ""
          }
          patient={patient}
          setActiveDoctorVisit={setActivePatient}
          colName={"comment"}
          apiUrl={`comment/${selectedTest.id}`}
        />
